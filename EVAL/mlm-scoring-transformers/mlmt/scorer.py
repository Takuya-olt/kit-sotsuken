...
class MLMScorer():
    ...
    def score_sentences(
        ...
        get_average_likelihood: bool=False,
    ) -> float:
        ...
        for i, sentence in enumerate(sentences):
            ...
            ave_log_likelihood = log_likelihood_sum / sentence_size
            
            score = ave_log_likelihood if get_average_likelihood else log_likelihood_sum
